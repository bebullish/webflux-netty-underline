...
/**
 * copy from NettyWebServer
 *
 * @author Marlon
 * @since 1.0.0
 */
public class UnderlineNettyWebServer implements WebServer {
	...
	private static final Log logger = LogFactory.getLog(UnderlineNettyWebServer.class);
	...
	public UnderlineNettyWebServer(HttpServer httpServer, UnderlineReactorHttpHandlerAdapter handlerAdapter, Duration lifecycleTimeout,
								   Shutdown shutdown) {
