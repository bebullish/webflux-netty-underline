...
/**
 * copy from ReactorServerHttpRequest
 *
 * @author Marlon
 * @since 1.0.0
 */
class UnderlineReactorServerHttpRequest extends AbstractServerHttpRequest {
	...
	public UnderlineReactorServerHttpRequest(HttpServerRequest request, NettyDataBufferFactory bufferFactory)
	...
	private static URI resolveBaseUrl(HttpServerRequest request) throws URISyntaxException {
		...
		if (header != null) {
			...
			String uri = scheme + "://" + localAddress.getHostString() + ":" + localAddress.getPort();
			return URI.create(uri);
		}
	}
