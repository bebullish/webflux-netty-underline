...
/**
 * copy from NettyReactiveWebServerFactory
 *
 * @author Marlon
 * @since 1.0.0
 */
public class UnderlineNettyReactiveWebServerFactory extends AbstractReactiveWebServerFactory {
	...
	public UnderlineNettyReactiveWebServerFactory() {
	}

	public UnderlineNettyReactiveWebServerFactory(int port) {
		super(port);
	}
	...
	public WebServer getWebServer(HttpHandler httpHandler) {
		...
		UnderlineReactorHttpHandlerAdapter handlerAdapter = new UnderlineReactorHttpHandlerAdapter(httpHandler);
		UnderlineNettyWebServer webServer = new UnderlineNettyWebServer(httpServer, handlerAdapter, this.lifecycleTimeout, getShutdown());
